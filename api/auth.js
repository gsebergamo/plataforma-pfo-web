...
const USUARIOS_DEFAULT = {
      ...
      'dir.comercial': { senha: 'dir2025!', nome: 'Joao Fernandes', email: '', alcada: 'diretor', centros_custo: ['*'] },
      'dir.tecnico':   { senha: 'dir2025!', nome: 'Ricardo Lima', email: '', alcada: 'diretor', centros_custo: ['*'] },
      'dir.financeiro':{ senha: 'dir2025!', nome: 'Maria Santos', email: '', alcada: 'diretor', centros_custo: ['*'] },
};
 ...
 * Retorna: { token, usuario, nome, alcada, centros_custo, email }
 */
...
// Exports para uso em outros endpoints (senha.js, dados.js, usuarios.js, recuperar-senha.js)
